    ...
    <div className={styles.container}>
      <div className={styles.onboardingSection} style={{ marginBottom: '2rem' }}>
        <div className={styles.onboardingHeader} style={{ marginBottom: '1rem' }}>
          <div>
            <h2 className={styles.onboardingTitle}>AI Agent Knowledge Base</h2>
            <p className={styles.onboardingSubtitle}>Train your agent with documents, URLs, and custom prompts.</p>
          </div>
      ...
      <div className={styles.statCard} style={{ minHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-tertiary)', borderStyle: 'dashed' }}>
        <div>
          <h3 style={{ textAlign: 'center', marginBottom: '1rem', color: 'var(--text-secondary)' }}>AI Agent Knowledge Base Dashboard</h3>
          <p>Knowledge base upload form...</p>
        </div>
      </div>
    </div>
  );
