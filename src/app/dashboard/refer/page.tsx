    ...
    <div className={styles.container}>
      <div className={styles.onboardingSection} style={{ marginBottom: '2rem' }}>
        <div className={styles.onboardingHeader} style={{ marginBottom: '1rem' }}>
          <div>
            <h2 className={styles.onboardingTitle}>Refer & Earn</h2>
            <p className={styles.onboardingSubtitle}>Share Amira and earn rewards for every successful referral.</p>
          </div>
      ...
      <div className={styles.statCard} style={{ minHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-tertiary)', borderStyle: 'dashed' }}>
        <div>
          <h3 style={{ textAlign: 'center', marginBottom: '1rem', color: 'var(--text-secondary)' }}>Refer & Earn Dashboard</h3>
          <p>Referral link and stats...</p>
        </div>
      </div>
    </div>
  );
