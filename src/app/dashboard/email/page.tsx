    ...
    <div style={{ maxWidth: '1080px', margin: '0 auto', width: '100%' }}>
      ...
      <div style={{ backgroundColor: '#ffffff', border: '1px solid var(--stripe-border)', borderRadius: '6px', padding: '1.25rem', boxShadow: 'var(--stripe-shadow-ambient)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          ...
          <button style={{ backgroundColor: 'var(--stripe-purple)', color: '#ffffff', border: 'none', borderRadius: '4px', padding: '0.5rem 1rem', fontSize: '12px', fontWeight: 500, cursor: 'pointer' }}>+ Add Inbox</button>
        </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            <tr style={{ borderBottom: '1px solid var(--stripe-border)' }}>
              <td style={{ padding: '1rem 0', fontSize: '12px', color: 'var(--stripe-navy)' }}>support@amira.com</td>
              ...
              <td style={{ padding: '1rem 0', fontSize: '12px', color: 'var(--stripe-purple)', cursor: 'pointer' }}>Configure</td>
            </tr>
            <tr>
              <td style={{ padding: '1rem 0', fontSize: '12px', color: 'var(--stripe-navy)' }}>sales@amira.com</td>
              ...
              <td style={{ padding: '1rem 0', fontSize: '12px', color: 'var(--stripe-purple)', cursor: 'pointer' }}>Reconnect</td>
            </tr>
          </tbody>
        </table>
      </div>
