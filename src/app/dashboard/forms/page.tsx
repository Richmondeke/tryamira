    ...
    <div className={styles.container}>
      <div className={styles.onboardingSection} style={{ marginBottom: '2rem' }}>
        <div className={styles.onboardingHeader} style={{ marginBottom: '1rem' }}>
          <div>
            <h2 className={styles.onboardingTitle}>Form Builder</h2>
            <p className={styles.onboardingSubtitle}>Create custom data collection forms for the AI to use.</p>
          </div>
      ...
      <div className={styles.statCard} style={{ minHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-tertiary)', borderStyle: 'dashed' }}>
        <div>
          <h3 style={{ textAlign: 'center', marginBottom: '1rem', color: 'var(--text-secondary)' }}>Form Builder Dashboard</h3>
          <p>Form builder interface...</p>
        </div>
      </div>
    </div>
  );
