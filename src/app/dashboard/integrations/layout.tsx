    ...
    <div style={{ maxWidth: '1080px', margin: '0 auto', width: '100%' }}>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          <div>
            <h1 style={{ fontSize: '24px', fontWeight: 300, color: 'var(--stripe-navy)', margin: '0 0 0.5rem 0' }}>Integrations & Channels</h1>
            <p style={{ color: 'var(--stripe-body)', fontSize: '13px', margin: 0 }}>Connect Amira with your software stack and messaging platforms.</p>
          </div>
        </div>
